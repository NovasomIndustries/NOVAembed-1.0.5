...
void NOVAembed::on_P_Generate_pushButton_clicked()
{
    ...
    {
        out << QString("/Devel/NOVAsom_SDK/Qt/NOVAembed/NOVAembed_P_Parser/bin/Debug/NOVAembed_P_Parser /Devel/NOVAsom_SDK/DtbUserWorkArea/PClass_bspf/temp/"+SDL_FileNameNoExtension+".bspf > /Devel/NOVAsom_SDK/Logs/P_bspf.log\n");
        if ( ui->EditBeforeGenerate_checkBox->isChecked())
            out << QString("kwrite /Devel/NOVAsom_SDK/DtbUserWorkArea/"+SDL_FileNameNoExtension+".dtsi\n");
        out << QString("./user_dtb_compile "+SDL_FileNameNoExtension+" P >> /Devel/NOVAsom_SDK/Logs/P_bspf.log\n");
        out << QString("/Devel/NOVAsom_SDK/Qt/NOVAembed/NOVAembed_P_Parser/bin/Debug/NOVAembed_P_Parser /Devel/NOVAsom_SDK/DtbUserWorkArea/PClass_bspf/temp/"+QUAD_FileNameNoExtension+".bspf >> /Devel/NOVAsom_SDK/Logs/P_bspf.log\n");
        if ( ui->EditBeforeGenerate_checkBox->isChecked())
